  ...
  <section className="relative min-h-screen flex items-center overflow-hidden bg-primary">
      ...
      <div className="absolute inset-0">
        ...
        <motion.div
          ...
          className="absolute bottom-1/4 right-1/4 w-[500px] h-[500px] bg-cyan/10 rounded-full blur-3xl"
        />
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div className="text-center lg:text-left">
            ...
            <motion.h1
              ...
              className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold font-display text-primary-foreground leading-[1.1] mb-6"
            >
              Transform Data Into{" "}
              <span className="gradient-text-light">Strategic</span>{" "}
              Intelligence
            </motion.h1>
            ...
            <motion.p
              ...
              className="text-lg md:text-xl text-primary-foreground/70 leading-relaxed mb-8 max-w-xl mx-auto lg:mx-0"
            >
            ...
            <div className="relative">
              ...
              <div className="glass-card-dark rounded-3xl p-8 relative overflow-hidden">
                ...
                <div className="relative space-y-6">
                  ...
                  {/* Chart Area */}
                  <div className="bg-primary-foreground/5 rounded-xl p-6 h-48 flex items-end gap-2">
              ...
              <motion.div
                ...
                className="absolute -top-8 -right-8 glass-card-dark rounded-2xl p-4 border border-cyan/20"
              >
              ...
              <motion.div
                ...
                className="absolute -bottom-6 -left-6 glass-card-dark rounded-2xl p-4 border border-cyan/20"
              >
                <div className="flex items-center gap-3">
